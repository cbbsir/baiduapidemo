...
//        System.out.println("jsion==="+httpUrl);
        ...
        map.put("from","en");
        map.put("to","zh");
        map.put("appid","20210507000817564");
        map.put("salt","4126TcVoQAHakrX9yfgZ");
        String sign = map.get("appid") + map.get("q") + map.get("salt") + "12345678";
        System.out.println("sign=" + sign);
        String md5Sign = MD5Util.crypt(sign);
        System.out.println("md5Sign=" + md5Sign);
        map.put("sign",md5Sign);
        String jsonResult=RequestUrl.sendPost("https://fanyi-api.baidu.com/api/trans/vip/translate?", map,"utf-8");
